...
- **Content**:
  ...
  {
    "assemblies": [
      "ClearVision.Product/src/ClearVision.Product.Application/bin/Debug/net8.0/ClearVision.Product.Application.dll"
    ],
    "generationSpecs": [
      {
        "modelType": "ClearVision.Product.Application.DTOs.*",
        "outputDir": "ClearVision.Product/src/ClearVision.Product.Desktop/wwwroot/src/types/generated",
...
- **File**: `ClearVision.Product.Desktop.csproj`
...
## Outcome
- C# DTOs in `ClearVision.Product.Application.DTOs` are mirrored as TypeScript interfaces in `wwwroot/src/types/generated`.
