...
> 生成时间 / Generated At: `2026-05-12 20:03:52 +08:00`
...
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.DeepLearning` | 深度学习 | 1 | 6 | 9 | 90 (A) | `1.0.0` | - | [DeepLearning](./DeepLearning.md) |
| `OperatorType.DualModalVoting` | 双模态投票 | 2 | 3 | 6 | 84 (B) | `1.0.0` | - | [DualModalVoting](./DualModalVoting.md) |
| `OperatorType.EdgePairDefect` | 边缘对缺陷 | 3 | 4 | 4 | 86 (A) | `1.0.0` | - | [EdgePairDefect](./EdgePairDefect.md) |
| `OperatorType.SurfaceDefectDetection` | 表面缺陷检测 | 2 | 4 | 5 | 90 (A) | `1.0.0` | - | [SurfaceDefectDetection](./SurfaceDefectDetection.md) |
...
| `OperatorType.ShapeMatching` | 旋转尺度模板匹配 | 2 | 2 | 10 | 90 (A) | `1.0.0` | - | [ShapeMatching](./ShapeMatching.md) |
| `OperatorType.TemplateMatching` | 模板匹配 | 2 | 6 | 3 | 86 (A) | `1.0.0` | - | [TemplateMatching](./TemplateMatching.md) |

### 变量 (4)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.CycleCounter` | 循环计数器 | 0 | 5 | 2 | 69 (C) | `1.0.0` | - | [CycleCounter](./CycleCounter.md) |
...
| `OperatorType.EdgeIntersection` | 边线交点 | 2 | 3 | 0 | 86 (A) | `1.0.0` | - | [EdgeIntersection](./EdgeIntersection.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.Aggregator` | 数据聚合 | 3 | 5 | 1 | 84 (B) | `1.0.0` | - | [Aggregator](./Aggregator.md) |
| `OperatorType.ArrayIndexer` | 数组索引器 | 1 | 3 | 2 | 69 (C) | `1.0.0` | - | [ArrayIndexer](./ArrayIndexer.md) |
| `OperatorType.BoxFilter` | 候选框过滤 (Bounding Box) | 2 | 3 | 9 | 84 (B) | `1.0.0` | - | [BoxFilter](./BoxFilter.md) |
...
| `OperatorType.PointAlignment` | 点位对齐 | 2 | 3 | 2 | 86 (A) | `1.0.0` | - | [PointAlignment](./PointAlignment.md) |
| `OperatorType.PointCorrection` | 点位修正 | 4 | 4 | 3 | 86 (A) | `1.0.0` | - | [PointCorrection](./PointCorrection.md) |
...
| `OperatorType.Undistort` | Undistort | 2 | 1 | 1 | 81 (B) | `1.0.0` | - | [Undistort](./Undistort.md) |

### 检测 (16)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.AngleMeasurement` | 角度测量 | 1 | 2 | 7 | 86 (A) | `1.0.0` | - | [AngleMeasurement](./AngleMeasurement.md) |
| `OperatorType.CaliperTool` | 卡尺工具 | 2 | 7 | 9 | 86 (A) | `1.0.0` | - | [CaliperTool](./CaliperTool.md) |
...
| `OperatorType.GapMeasurement` | 间隙测量 | 2 | 6 | 4 | 86 (A) | `1.0.0` | - | [GapMeasurement](./GapMeasurement.md) |
| `OperatorType.GeoMeasurement` | 几何测量 | 2 | 5 | 2 | 86 (A) | `1.0.0` | - | [GeoMeasurement](./GeoMeasurement.md) |
| `OperatorType.GeometricFitting` | Geometric Fitting | 1 | 2 | 8 | 90 (A) | `1.0.0` | - | [GeometricFitting](./GeometricFitting.md) |
| `OperatorType.GeometricTolerance` | 几何公差 | 1 | 5 | 9 | 86 (A) | `1.0.0` | - | [GeometricTolerance](./GeometricTolerance.md) |
...
| `OperatorType.LineMeasurement` | 直线测量 | 1 | 5 | 4 | 86 (A) | `1.0.0` | - | [LineMeasurement](./LineMeasurement.md) |
| `OperatorType.Measurement` | 测量 | 3 | 2 | 5 | 86 (A) | `1.0.0` | - | [Measurement](./Measurement.md) |
| `OperatorType.PixelStatistics` | 像素统计 | 2 | 6 | 5 | 86 (A) | `1.0.0` | - | [PixelStatistics](./PixelStatistics.md) |
| `OperatorType.PointLineDistance` | 点线距离 | 2 | 2 | 0 | 86 (A) | `1.0.0` | - | [PointLineDistance](./PointLineDistance.md) |
| `OperatorType.SharpnessEvaluation` | 清晰度评估 | 1 | 3 | 6 | 86 (A) | `1.0.0` | - | [SharpnessEvaluation](./SharpnessEvaluation.md) |
...
| `OperatorType.Delay` | 延时 | 1 | 2 | 1 | 66 (C) | `1.0.0` | - | [Delay](./Delay.md) |
| `OperatorType.ForEach` | ForEach 循环 | 1 | 1 | 4 | 73 (B) | `1.0.0` | - | [ForEach](./ForEach.md) |
| `OperatorType.ResultJudgment` | 结果判定 | 2 | 3 | 8 | 80 (B) | `1.0.0` | - | [ResultJudgment](./ResultJudgment.md) |
| `OperatorType.TryCatch` | 异常捕获 | 1 | 4 | 3 | 83 (B) | `1.0.0` | - | [TryCatch](./TryCatch.md) |

### 特征提取 (4)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.BlobAnalysis` | Blob分析 | 2 | 4 | 17 | 90 (A) | `1.0.0` | - | [BlobAnalysis](./BlobAnalysis.md) |
| `OperatorType.ContourDetection` | 轮廓检测 | 1 | 3 | 8 | 84 (B) | `1.0.0` | - | [ContourDetection](./ContourDetection.md) |
| `OperatorType.EdgeDetection` | Edge Detection | 1 | 2 | 8 | 90 (A) | `1.0.0` | - | [EdgeDetection](./EdgeDetection.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.Comment` | 注释 | 1 | 2 | 1 | 63 (C) | `1.0.0` | - | [Comment](./Comment.md) |
| `OperatorType.RoiManager` | ROI管理器 | 1 | 2 | 10 | 90 (A) | `1.0.0` | - | [RoiManager](./RoiManager.md) |

### 输出 (2)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.ImageSave` | 图像保存 | 1 | 2 | 3 | 90 (A) | `1.0.0` | - | [ImageSave](./ImageSave.md) |
| `OperatorType.ResultOutput` | 结果输出 | 4 | 6 | 2 | 88 (A) | `1.0.0` | - | [ResultOutput](./ResultOutput.md) |

### 通信 (8)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.HttpRequest` | HTTP 请求 | 2 | 3 | 6 | 90 (A) | `1.0.0` | - | [HttpRequest](./HttpRequest.md) |
| `OperatorType.MitsubishiMcCommunication` | 三菱MC通信 | 1 | 2 | 12 | 70 (B) | `1.0.0` | - | [MitsubishiMcCommunication](./MitsubishiMcCommunication.md) |
| `OperatorType.ModbusCommunication` | Modbus通信 | 1 | 2 | 8 | 90 (A) | `1.0.0` | - | [ModbusCommunication](./ModbusCommunication.md) |
...
| `OperatorType.SerialCommunication` | 串口通信 | 1 | 1 | 8 | 90 (A) | `1.0.0` | - | [SerialCommunication](./SerialCommunication.md) |
| `OperatorType.SiemensS7Communication` | 西门子S7通信 | 1 | 2 | 14 | 70 (B) | `1.0.0` | - | [SiemensS7Communication](./SiemensS7Communication.md) |
| `OperatorType.TcpCommunication` | TCP通信 | 1 | 2 | 6 | 90 (A) | `1.0.0` | - | [TcpCommunication](./TcpCommunication.md) |

### 通用 (4)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.LogicGate` | 逻辑门 | 2 | 1 | 1 | 66 (C) | `1.0.0` | - | [LogicGate](./LogicGate.md) |
...
| `OperatorType.TriggerModule` | 触发模块 | 1 | 3 | 3 | 80 (B) | `1.0.0` | - | [TriggerModule](./TriggerModule.md) |

### 采集 (1)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.ImageAcquisition` | 图像采集 | 2 | 1 | 6 | 73 (B) | `1.0.0` | - | [ImageAcquisition](./ImageAcquisition.md) |

### 预处理 (23)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.AdaptiveThreshold` | 自适应阈值 | 1 | 1 | 5 | 84 (B) | `1.0.0` | - | [AdaptiveThreshold](./AdaptiveThreshold.md) |
| `OperatorType.BilateralFilter` | 双边滤波 | 1 | 1 | 3 | 90 (A) | `1.0.0` | - | [BilateralFilter](./BilateralFilter.md) |
...
| `OperatorType.Filtering` | Gaussian Blur | 1 | 1 | 4 | 84 (B) | `1.0.0` | Gaussian Blur (OpenCV) | [Filtering](./Filtering.md) |
...
| `OperatorType.ImageBlend` | 图像融合 | 2 | 1 | 3 | 84 (B) | `1.0.0` | - | [ImageBlend](./ImageBlend.md) |
| `OperatorType.ImageCrop` | 图像裁剪 | 1 | 1 | 4 | 84 (B) | `1.0.0` | - | [ImageCrop](./ImageCrop.md) |
| `OperatorType.ImageDiff` | 图像对比 | 2 | 2 | 0 | 79 (B) | `1.0.0` | - | [ImageDiff](./ImageDiff.md) |
...
| `OperatorType.LaplacianSharpen` | 拉普拉斯锐化 | 1 | 1 | 3 | 84 (B) | `1.0.0` | - | [LaplacianSharpen](./LaplacianSharpen.md) |
...
| `OperatorType.MorphologicalOperation` | Morphological Operation | 1 | 1 | 7 | 84 (B) | `1.0.0` | - | [MorphologicalOperation](./MorphologicalOperation.md) |
...
| `OperatorType.ShadingCorrection` | 光照校正 | 2 | 1 | 2 | 86 (A) | `1.0.0` | - | [ShadingCorrection](./ShadingCorrection.md) |
| `OperatorType.Thresholding` | 二值化 | 1 | 1 | 4 | 84 (B) | `1.0.0` | - | [Thresholding](./Thresholding.md) |

### 颜色处理 (2)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.ColorDetection` | 颜色检测 | 1 | 4 | 9 | 86 (A) | `1.0.0` | - | [ColorDetection](./ColorDetection.md) |
| `OperatorType.ColorMeasurement` | 颜色测量 | 2 | 8 | 8 | 86 (A) | `1.0.0` | - | [ColorMeasurement](./ColorMeasurement.md) |
