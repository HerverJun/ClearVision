...
- 组合指纹 (Generation Fingerprint)：`3C07D1FA48076A0F74C25FC655BECFAE5341A9E47AA407C04B45F2D074B0BDC8`
...
|------|------|----------|
| 1.1.3 | 2026-07-16 | 按当前最终运行时元数据、条件契约和显式依赖口径重生成 / Regenerated from effective runtime metadata and declared dependencies |
