...
|--------|------|------|--------|------|------|------|
| `FrameCount` | 帧数 | `int` | 8 | [1, 64] | Yes | - |
| `Mode` | 模式 | `enum` | Mean | Mean/均值；Median/中值 | Yes | - |
...
| `FrameCount` | 帧数 | `Integer` | 数值结果，可用于测量、阈值判定、统计或报表输出。 |
...
- 组合指纹 (Generation Fingerprint)：`A2CBB33A0A428C7AA03CFF18EACE50BB52D83ACF6B57C0BF6404A2C412AEAA75`
