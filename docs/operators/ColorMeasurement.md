...
- 组合指纹 (Generation Fingerprint)：`C2E255FDE8642355411954D20AA3024D103FA13175B2885C9747E971C828C162`
...
|------|------|----------|
| 2.0.0 | 2026-09-01 | 按当前最终运行时元数据、条件契约和显式依赖口径重生成 / Regenerated from effective runtime metadata and declared dependencies |
