...
| 标签 (Tags) | `分类:SegmentationAndRegion`, `分类显示:分割与区域`, `生命周期:Stable`, `算法类型:基于OpenCV` |
...
- 组合指纹 (Generation Fingerprint)：`96FC49BBF2F0A115C6EE6C317F08595A2122145E51946B9A35D2C728D8B2034D`
