...
|--------|------|------|--------|------|------|------|
| `LabelBy` | Label By | `enum` | Area | Area/Area；Circularity/Circularity；AspectRatio/AspectRatio；Position/Position | Yes | - |
| `Thresholds` | Thresholds | `string` | [] | - | Yes | - |
| `DrawLabels` | Draw Labels | `bool` | true | - | Yes | - |
