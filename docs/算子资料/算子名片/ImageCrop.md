...
该算子用于ROI区域提取。运行时从声明输入端口读取数据，按参数表解析配置，并把处理结果写入输出字典。
...
| `X` | 起始X | `int` | 0 | >= 0 | Yes | - |
| `Y` | 起始Y | `int` | 0 | >= 0 | Yes | - |
| `Width` | 宽度 | `int` | 100 | >= 1 | Yes | - |
| `Height` | 高度 | `int` | 100 | >= 1 | Yes | - |
...
- 组合指纹 (Generation Fingerprint)：`3990A89C757A8679B317A6EA05211D9FB9042BC0B6C6535B470E4C072C24565B`
