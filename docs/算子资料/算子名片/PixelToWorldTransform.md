...
| `InputFrame` | Input Frame | `enum` | Auto | Auto/Auto；ImageFull/Image Full；RoiLocal/ROI Local；Undistorted/Undistorted；World2D/World 2D | Yes | - |
| `OutputFrame` | Output Frame | `enum` | Auto | Auto/Auto；ImageFull/Image Full；RoiLocal/ROI Local；Undistorted/Undistorted；World2D/World 2D | Yes | - |
