...
**源码位置**：
- `ClearVision.Product.Application/Services/InspectionService.cs`（实例字段）
- `ClearVision.Product.Desktop/DependencyInjection.cs`（Scoped 注册）
...
**源码位置**：
- `ClearVision.Product.Desktop/ApiEndpoints.cs`（HTTP 接口）
- `ClearVision.Product.Desktop/WebMessageHandler.cs`（WebMessage 推送）
...
**源码位置**：
- `ClearVision.Product.Infrastructure/Services/OperatorPreviewService.cs`
- `ClearVision.Product.Infrastructure/Services/FlowExecutionService.cs`
...
**改动文件**：
- 新增：`ClearVision.Product.Application/Services/InspectionRuntimeCoordinator.cs`
- 修改：`ClearVision.Product.Application/Services/InspectionService.cs`（移除实例字段）
- 修改：`ClearVision.Product.Desktop/DependencyInjection.cs`（注册单例）
- 修改：`ClearVision.Product.Desktop/ApiEndpoints.cs`（调用协调器）
...
**改动文件**：
- 新增：`ClearVision.Product.Application/Events/IInspectionEventBus.cs`
- 修改：`ClearVision.Product.Application/Services/InspectionService.cs`（发布事件）
- 修改：`ClearVision.Product.Desktop/ApiEndpoints.cs`（新增 SSE 端点）
- 修改：`ClearVision.Product.Desktop/WebMessageHandler.cs`（订阅事件总线）
...
**改动文件**：
- 新增：`ClearVision.Product.Infrastructure/Services/FlowNodePreviewService.cs`
- 修改：`ClearVision.Product.Desktop/ApiEndpoints.cs`（新增 `POST /api/flows/preview-node`）
...
**改动文件**：
- 新增：`ClearVision.Product.Infrastructure/Services/PreviewMetricsAnalyzer.cs`（提取指标和诊断）
- 扩展：`ClearVision.Product.Infrastructure/Services/OperatorPreviewService.cs`（新增 `PreviewWithMetricsAsync`）
- 扩展：`ClearVision.Product.Infrastructure/Services/ParameterRecommender.cs`（新增 `RecommendNextAsync`）
- 新增：`ClearVision.Product.Application/Services/AutoTuneService.cs`（编排迭代循环）
- 修改：`ClearVision.Product.Desktop/ApiEndpoints.cs`（新增 `/api/operators/{type}/auto-tune`）
