...
```csharp
// ClearVision.Product.Application/Services/IInspectionRuntimeCoordinator.cs
...
```csharp
// ClearVision.Product.Application/Services/InspectionRuntimeCoordinator.cs
...
```csharp
// ClearVision.Product.Desktop/DependencyInjection.cs
// 改为单例
...
```csharp
// ClearVision.Product.Application/Services/InspectionService.cs
...
```csharp
// ClearVision.Product.Application/Events/IInspectionEventBus.cs
...
```csharp
// ClearVision.Product.Infrastructure/Events/InMemoryInspectionEventBus.cs
...
```csharp
// ClearVision.Product.Desktop/ApiEndpoints.cs
...
```csharp
// ClearVision.Product.Desktop/WebMessageHandler.cs
...
```csharp
// ClearVision.Product.Infrastructure/Services/FlowNodePreviewService.cs
...
```csharp
// ClearVision.Product.Infrastructure/Services/PreviewMetricsAnalyzer.cs
...
```csharp
// ClearVision.Product.Application/Services/AutoTuneService.cs
