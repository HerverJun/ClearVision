...
【输出文件】
- ClearVision.Product/src/ClearVision.Product.Infrastructure/Diagnostics/PerformanceProfiler.cs
- ClearVision.Product/tests/ClearVision.Product.Tests/Diagnostics/PerformanceProfilerTests.cs
...
【输出文件】
- ClearVision.Product/src/ClearVision.Product.Infrastructure/TestData/TestDataGenerator.cs
- scripts/TestDataGenerator/Program.cs
- scripts/TestDataGenerator/TestDataGenerator.csproj
- ClearVision.Product/tests/TestData/*.png
- ClearVision.Product/tests/TestData/*.pcd
...
```markdown
【上下文】
项目: ClearVision.Product.Infrastructure
命名空间: ClearVision.Product.Infrastructure.ImageProcessing
现有依赖: OpenCvSharp4
...
| 测试项 | 方法 | 通过标准 |
|--------|------|----------|
| 测试数据生成 | 运行 scripts/TestDataGenerator（默认输出 ClearVision.Product/tests/TestData） | 生成10种测试图 |
...
- 自动化测试文件：`ClearVision.Product/tests/ClearVision.Product.Tests/Operators/Stage1_W4_ShapeMatchVerificationTests.cs`
- 覆盖项：精度阈值（<0.1px）、30%遮挡（score>0.6）、光照±50%（score change<0.1）
- 建议运行命令：`dotnet test .\\ClearVision.Product\\tests\\ClearVision.Product.Tests\\ClearVision.Product.Tests.csproj -c Release --filter FullyQualifiedName~Stage1_W4_ShapeMatchVerificationTests`
...
- 性能预算验收测试：`ClearVision.Product/tests/ClearVision.Product.Tests/Integration/PerformanceBudgetAcceptanceTests.cs`
...
- 建议运行命令：`dotnet test .\\ClearVision.Product\\tests\\ClearVision.Product.Tests\\ClearVision.Product.Tests.csproj -c Release --filter FullyQualifiedName~PerformanceBudgetAcceptanceTests`
