...
- [x] 1. 修复 `ImageWrapper` 生命周期竞态
  - 文件: `ClearVision.Product/src/ClearVision.Product.Infrastructure/Operators/ImageWrapper.cs`
...
- [x] 2. 修复 `Guid.Empty` 初始输入的多根引用计数
  - 文件: `ClearVision.Product/src/ClearVision.Product.Infrastructure/Services/FlowExecutionService.cs`
...
- [x] 3. 修复 `RuntimeHost.StopAsync` 的取消安全
  - 文件: `ClearVision.Product/src/ClearVision.Product.Runtime/RuntimeHost.cs`
...
- [x] 5. 修复相机协调器的启动失败回滚
  - 文件: `ClearVision.Product/src/ClearVision.Product.Infrastructure/Cameras/CameraFrameStreamCoordinator.cs`
...
- [x] 6. 把空 catch 改成可诊断的失败路径
  - 文件: `ClearVision.Product/src/ClearVision.Product.Application/Services/OperatorService.cs`
  - 文件: `ClearVision.Product/src/ClearVision.Product.Application/Services/ProjectService.cs`
...
- [x] 回归验证:
  - `ClearVision.Product.Tests.Integration.FlowConnectionScenariosTests`
  - `ClearVision.Product.Tests.Runtime.RuntimeMvpTests`
  - `ClearVision.Product.Tests.Runtime.RuntimeWriterBackpressureTests`
  - `ClearVision.Product.Tests.Memory.Sprint1_MemoryPoolTests`
  - `ClearVision.Product.Tests.Services.OperatorServiceTests`
  - `ClearVision.Product.Tests.Services.ProjectServiceTests`
  - `ClearVision.Product.Desktop.Tests.CameraFrameStreamCoordinatorTests`
