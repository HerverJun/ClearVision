...
> 文档状态：**G4_DONE_G5_APPROVED**
> 本计划已经结合 F03 最终实现、当前 `studio-ui-next` 分支代码事实、原 F04 初稿及独立复审意见修订。
> Prompt 4/4 已完成 G3B Project backend hardening、G3C frontend lifecycle 与 G4 产品壳层/导航/统一 Leave Guard/自动视觉闭环；G5 已解锁，G6 仍须继续串行门禁。
...
PLAN_STATUS=G4_DONE_G5_APPROVED
