...
- F09-R2：产品修复锚点为 source SHA `d1c82ba88e351a2d48bcfae7f97e047483dbba98`，后续产品源修复为 `c83dcc114290cf73e5e8d9b91e7b49732db8ec68` 与 `1545bca25`；当前本地证据运行 SHA 为 `9dd69bd2bde44e8ea5b7285bfd18f47e02f95007`。Profile、Rollback、Final、Browser、Product、Desktop 和 Release 125% 证据已完成，`ROLLBACK_DRILL=PASS`；审计分支推送与 Remote CI/Final Gate 待执行。当前状态由 [F09 完成报告](./F09_完成报告.md)、[F09 Final Evidence Manifest](./F09_FinalEvidenceManifest.md)、[F09 Open Issues](./F09_OPEN_ISSUES.md) 和 [F09 Cutover/Rollback 手册](./F09_Cutover与Rollback操作手册.md) 维护：`F09_R_STATE=LOCAL_EVIDENCE_COMPLETE`、`F09_STATE=ENGINEERING_DONE_WITH_ACCEPTANCE_DEBT`、`FRONTEND_MIGRATION_MAINLINE=COMPLETE`、`CONFIGURED_PROFILE=NEXT_DEFAULT`、`EFFECTIVE_DEFAULT_UI_ROOT=STUDIO_UI_NEXT`、`LEGACY_ROLE=FALLBACK_ONLY`、`OPERATOR_READONLY_UI_PROJECTION=PASS`、`M_SERIES_ENTRY=READY_AFTER_REMOTE_AUDIT`、`ROLLBACK_DRILL=PASS`、`REMOTE_CI=AWAITING`、`FINAL_GATE=AWAITING`、`PRODUCTION_ACCEPTANCE=NOT_GRANTED`。独立 no-Node、完整 DPI、现场硬件和生产 soak 保留为 acceptance debt。
