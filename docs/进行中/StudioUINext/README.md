...
- F09-R2：工程修复已提交于 source SHA `d1c82ba88e351a2d48bcfae7f97e047483dbba98`，审计分支为 `audit/f09-r2-d1c82ba88`。当前状态由 [F09 完成报告](./F09_完成报告.md)、[F09 Final Evidence Manifest](./F09_FinalEvidenceManifest.md)、[F09 Open Issues](./F09_OPEN_ISSUES.md) 和 [F09 Cutover/Rollback 手册](./F09_Cutover与Rollback操作手册.md) 维护：`F09_R_STATE=IMPLEMENTED_AWAITING_ROLLBACK`、`F09_STATE=PARTIAL`、`FRONTEND_MIGRATION_MAINLINE=NEAR_COMPLETE`、`CONFIGURED_PROFILE=NEXT_DEFAULT`、`EFFECTIVE_DEFAULT_UI_ROOT=STUDIO_UI_NEXT`、`LEGACY_ROLE=FALLBACK_ONLY`、`OPERATOR_READONLY_UI_PROJECTION=PASS`、`M_SERIES_ENTRY=BLOCKED_BY_ROLLBACK`、`ROLLBACK_DRILL=NOT_RUN`、`PRODUCTION_ACCEPTANCE=NOT_GRANTED`。
