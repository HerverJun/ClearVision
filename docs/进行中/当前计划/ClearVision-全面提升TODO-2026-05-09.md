...
> 2026-08-28 专业当前性复核：原始 checkbox 已失真，不再单独作为执行状态权威。按 46 个主题统计，35 个为 `IMPLEMENTED_SYNC_PENDING`、10 个为 `OPEN_RESCOPED`、P2-2 被当前 production-root 架构决定取代；按 147 个 checkbox 统计，原勾 3、当前实现待同步 106、实质残项 33、总关闭条件 5。唯一执行责任见 [未尽事项统一补齐 TODO](./ClearVision-未尽事项统一补齐TODO-2026-08-28.md)，本页继续保留为早期规划快照，不机械批量勾选，也不得按过时文字重新实施。
> 已实现待同步主题：`P0-1~P0-8、P0-10、P0-11；P1-1~P1-6、P1-8~P1-13、P1-15、P1-17~P1-19、P1-21、P1-22；P2-1、P2-3~P2-5、P2-10~P2-12`。窄化后仍开放：`P0-9、P1-7、P1-14、P1-16、P1-20、P1-23、P2-6~P2-9`。P1-2 的变量作用域主体和 P1-8 的聚合/分页主体不得被后续新问题反向判成整项未完成。
