...
| `OperatorType.ImageNormalize` | 图像归一化 | `Stable` | 1 | 6 | 4 | 96 (A) | `1.0.1` | MinMax range normalization / floating ZScore standardization / histogram equalization | [ImageNormalize](./operators/ImageNormalize.md) |
