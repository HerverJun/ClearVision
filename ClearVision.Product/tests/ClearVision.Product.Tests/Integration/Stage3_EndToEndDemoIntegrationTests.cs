...
public sealed class Stage3_EndToEndDemoIntegrationTests
{
    ...
    private static string ResolveTestDataPath(string relativePath)
    {
        ...
        while (dir != null && !dir.Name.Equals("ClearVision.Product", StringComparison.OrdinalIgnoreCase))
        {
            dir = dir.Parent;
        }
        ...
        if (dir == null)
        {
            throw new DirectoryNotFoundException("Failed to resolve ClearVision.Product root.");
        }
