...
public class OperatorBenchmarkTests
{
    ...
    private readonly IReadOnlyDictionary<OperatorType, ClearVision.Product.Core.Services.OperatorMetadata> _metadata;
    ...
    private static Dictionary<string, object> BuildInputs(ClearVision.Product.Core.Services.OperatorMetadata? metadata, Mat baseImage)
    {
        var inputs = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
