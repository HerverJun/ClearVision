...
### 新建文件（5 个）
1. `ClearVision.Product/src/ClearVision.Product.Infrastructure/Operators/ForEachOperator.cs`
2. `ClearVision.Product/src/ClearVision.Product.Infrastructure/Operators/ArrayIndexerOperator.cs`
3. `ClearVision.Product/src/ClearVision.Product.Infrastructure/Operators/JsonExtractorOperator.cs`
4. `ClearVision.Product/src/ClearVision.Product.Infrastructure/Services/FlowLinter.cs`
5. `ClearVision.Product/tests/ClearVision.Product.Tests/Operators/Sprint2_*Tests.cs` (3 个)
6. `ClearVision.Product/tests/ClearVision.Product.Tests/Sprint2_Acceptance_Checklist.md` (本文件)

### 修改文件（2 个）
1. `ClearVision.Product/src/ClearVision.Product.Core/Enums/OperatorEnums.cs` - 添加新算子类型
2. `ClearVision.Product/src/ClearVision.Product.Desktop/DependencyInjection.cs` - 注册新算子
