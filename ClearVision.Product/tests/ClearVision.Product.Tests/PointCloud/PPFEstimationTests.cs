...
using ClearVision.Product.Infrastructure.PointCloud.Features;
...
public sealed class PPFEstimationTests
{
    ...
    private static ClearVision.Product.Infrastructure.PointCloud.PointCloud FlipNormals(ClearVision.Product.Infrastructure.PointCloud.PointCloud source)
    {
