...
### 实现检查
- [x] AIPromptBuilder.cs 文件存在于 `src/ClearVision.Product.Infrastructure/AI/`
...
### 实现检查
- [x] AIGeneratedFlowParser.cs 文件存在于 `src/ClearVision.Product.Infrastructure/AI/`
...
### 实现检查
- [x] StubRegistryBuilder.cs 文件存在于 `src/ClearVision.Product.Infrastructure/AI/DryRun/`
- [x] 实现所有算子的默认 Stub 定义
- [x] 支持根据算子元数据生成 Stub
...
### 实现检查
- [x] AIWorkflowService.cs 文件存在于 `src/ClearVision.Product.Infrastructure/AI/`
...
### 测试文件
- [x] `tests/ClearVision.Product.Tests/AI/Sprint5_AIWorkflowServiceTests.cs`
...
### 文件清单
```
src/ClearVision.Product.Infrastructure/AI/
├── AIPromptBuilder.cs              ✅
...
tests/ClearVision.Product.Tests/AI/
