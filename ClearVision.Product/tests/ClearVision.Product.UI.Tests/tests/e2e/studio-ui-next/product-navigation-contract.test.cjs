...
assert.deepEqual(f04Default.forbiddenRoutes, [
  '/overview',
  '/operators',
  '/stations',
  '/diagnostics',
...
assert.equal(f04Default.stationsRule, 'pilot-not-exposed');
...
assert.equal(f04Stations.stationsRule, 'pilot-not-exposed');
