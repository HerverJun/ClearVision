...
public sealed class RuntimeHost : IAsyncDisposable
{
    ...
    public RuntimeHostSnapshot GetSnapshot()
    {
        return new RuntimeHostSnapshot
        {
            ...
            PackageVersion = _loadedPackage?.Manifest.RuntimeApiVersion,
            SourceProjectId = _loadedPackage?.Manifest.SourceProjectId,
            SourceProjectRevision = _loadedPackage?.Manifest.SourceProjectRevision,
