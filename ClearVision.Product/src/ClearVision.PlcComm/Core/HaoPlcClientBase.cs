...
namespace ClearVision.PlcComm.Core;
...
public abstract class HaoPlcClientBase : IPlcClient
{
    ...
    protected static OperateResult ToClearVisionResult(HslCommunication.OperateResult result)
    {
    ...
    protected static OperateResult<T> ToClearVisionResult<T>(HslCommunication.OperateResult<T> result)
    {
        return result.IsSuccess
