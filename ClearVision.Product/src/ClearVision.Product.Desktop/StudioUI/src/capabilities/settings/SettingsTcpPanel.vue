...
.tcp-send-response { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: baseline; gap: var(--cv-space-3); margin-top: var(--cv-space-3); padding: var(--cv-space-2) var(--cv-space-3); border-left: 2px solid var(--cv-color-brand-500); background: var(--cv-surface-raised); }
