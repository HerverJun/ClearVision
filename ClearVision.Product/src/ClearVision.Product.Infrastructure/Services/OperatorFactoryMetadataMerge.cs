...
{
    private const string StrictMetadataScanSwitchName = "ClearVision.Product.OperatorFactory.StrictMetadataScan";
    private const string StrictMetadataScanEnvironmentVariable = "CLEARVISION_OPERATOR_FACTORY_STRICT_METADATA_SCAN";
