...
/// <summary>
/// Applies the current UI-facing display names/categories while runtime metadata is sourced from attributes.
/// </summary>
internal static class OperatorMetadataLocalization
{
    private static readonly IReadOnlyDictionary<OperatorType, LocalizedMetadata> LegacyDisplayMap =
        new Dictionary<OperatorType, LocalizedMetadata>
        {
            ...
            [OperatorType.BlobLabeling] = new("Blob分类标注", "定位"),
            ...
            [OperatorType.ColorDetection] = new("颜色分析", "颜色处理"),
            [OperatorType.ColorMeasurement] = new("颜色测量", "颜色处理"),
            [OperatorType.Comment] = new("注释", "辅助"),
            [OperatorType.Comparator] = new("数值比较", "逻辑工具"),
            ...
            [OperatorType.CoordinateTransform] = new("像素到物理坐标（单点）", "标定"),
            ...
            [OperatorType.DetectionSequenceJudge] = new("检测顺序判定", "AI检测"),
            ...
            [OperatorType.EdgePairDefect] = new("边缘间距缺陷检测", "AI检测"),
            ...
            [OperatorType.GeometricTolerance] = new("二维几何公差判定", "检测"),
            ...
            [OperatorType.HandEyeCalibration] = new("手眼标定", "标定"),
            [OperatorType.HandEyeCalibrationValidator] = new("手眼标定验证", "标定"),
            ...
            [OperatorType.ImageDiff] = new("图像差异率分析", "预处理"),
            ...
            [OperatorType.InverseFFT1D] = new("信号/图像逆傅里叶变换（IFFT）", "频域"),
            ...
            [OperatorType.ModbusCommunication] = new("Modbus TCP通信", "通信"),
            ...
            [OperatorType.PointAlignment] = new("点位偏差计算", "数据处理"),
            [OperatorType.PointCorrection] = new("点位刚性补偿", "数据处理"),
            [OperatorType.PointLineDistance] = new("点线距离", "检测"),
            [OperatorType.PointSetTool] = new("点集工具", "逻辑工具"),
            [OperatorType.PolarUnwrap] = new("极坐标展开", "图像处理"),
            [OperatorType.PlanarMatching] = new("平面特征匹配", "匹配定位"),
            [OperatorType.PositionCorrection] = new("ROI位姿补偿（像素）", "定位"),
            ...
            [OperatorType.RectangleRegion] = new("矩形框定义", "几何"),
            ...
            [OperatorType.RoiManager] = new("ROI裁剪与掩膜", "辅助"),
            ...
            [OperatorType.SubpixelEdgeDetection] = new("亚像素边缘", "特征提取"),
            ...
            [OperatorType.Thresholding] = new("全局阈值处理", "预处理"),
            ...
            [OperatorType.TryCatch] = new("Try分支透传", "流程控制"),
            ...
            [OperatorType.FFT1D] = new("信号/图像傅里叶变换（FFT）", "频域"),
        };
