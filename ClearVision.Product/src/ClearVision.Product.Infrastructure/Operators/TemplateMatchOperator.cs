...
[OperatorParameterRule("RoiX", DisabledWhenAll = new[] { "UseRoi==false" }, HiddenWhenAll = new[] { "UseRoi==false" }, IgnoredWhenAll = new[] { "UseRoi==false" }, ReasonCode = "TEMPLATE_MATCHING_ROI_ONLY_WHEN_ENABLED")]
[OperatorParameterRule("RoiY", DisabledWhenAll = new[] { "UseRoi==false" }, HiddenWhenAll = new[] { "UseRoi==false" }, IgnoredWhenAll = new[] { "UseRoi==false" }, ReasonCode = "TEMPLATE_MATCHING_ROI_ONLY_WHEN_ENABLED")]
[OperatorParameterRule("RoiWidth", RequiredWhenAll = new[] { "UseRoi==true" }, DisabledWhenAll = new[] { "UseRoi==false" }, HiddenWhenAll = new[] { "UseRoi==false" }, IgnoredWhenAll = new[] { "UseRoi==false" }, ReasonCode = "TEMPLATE_MATCHING_ROI_ONLY_WHEN_ENABLED")]
[OperatorParameterRule("RoiHeight", RequiredWhenAll = new[] { "UseRoi==true" }, DisabledWhenAll = new[] { "UseRoi==false" }, HiddenWhenAll = new[] { "UseRoi==false" }, IgnoredWhenAll = new[] { "UseRoi==false" }, ReasonCode = "TEMPLATE_MATCHING_ROI_ONLY_WHEN_ENABLED")]
[OperatorParameterRule("OriginX", RequiredWhenAll = new[] { "OriginMode==Custom" }, DisabledWhenAll = new[] { "OriginMode!=Custom" }, HiddenWhenAll = new[] { "OriginMode!=Custom" }, IgnoredWhenAll = new[] { "OriginMode!=Custom" }, ReasonCode = "TEMPLATE_MATCHING_CUSTOM_ORIGIN")]
[OperatorParameterRule("OriginY", RequiredWhenAll = new[] { "OriginMode==Custom" }, DisabledWhenAll = new[] { "OriginMode!=Custom" }, HiddenWhenAll = new[] { "OriginMode!=Custom" }, IgnoredWhenAll = new[] { "OriginMode!=Custom" }, ReasonCode = "TEMPLATE_MATCHING_CUSTOM_ORIGIN")]
[OperatorParameterRule("AngleStart", DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("AngleExtent", RequiredWhenAll = new[] { "EnablePoseSearch==true" }, DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("AngleStep", RequiredWhenAll = new[] { "EnablePoseSearch==true" }, DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("ScaleMin", RequiredWhenAll = new[] { "EnablePoseSearch==true" }, DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("ScaleMax", RequiredWhenAll = new[] { "EnablePoseSearch==true" }, DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("ScaleStep", RequiredWhenAll = new[] { "EnablePoseSearch==true" }, DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
[OperatorParameterRule("PyramidLevels", DisabledWhenAll = new[] { "EnablePoseSearch==false" }, HiddenWhenAll = new[] { "EnablePoseSearch==false" }, IgnoredWhenAll = new[] { "EnablePoseSearch==false" }, ReasonCode = "TEMPLATE_MATCHING_POSE_SEARCH")]
