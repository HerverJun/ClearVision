...
[OperatorParam("CompareListDelimiter", "Compare List Delimiter", "string", Description = "列表条件使用的主分隔符。", DefaultValue = ",")]
[OperatorParam("CompareListDelimiters", "Additional Compare List Delimiters", "string", Description = "列表条件使用的附加分隔符，多个值用 | 分隔。", DefaultValue = "")]
...
[OperatorParam("CompareFieldName", "Compare Field Name", "string", Description = "从 Compare 输入或当前 Value 中读取比较值的字段路径。", DefaultValue = "")]
[OperatorParam("FailOnMissingField", "Fail On Missing Field", "bool", Description = "启用后，FieldName 字段缺失时执行失败。", DefaultValue = false)]
[OperatorParam("FailOnEvaluationError", "Fail On Evaluation Error", "bool", Description = "启用后，条件计算错误时执行失败。", DefaultValue = false)]
[OperatorParam("NumericTolerance", "Numeric Tolerance", "double", Description = "数值比较允许的绝对误差。", DefaultValue = 0.0, Min = 0.0)]
[OperatorParam("IgnoreCase", "Ignore Case", "bool", Description = "启用后，字符串比较和正则匹配忽略大小写。", DefaultValue = false)]
[OperatorParam("RangeMin", "Range Min", "double", Description = "范围判断的默认下限。", DefaultValue = 0.0)]
[OperatorParam("RangeMax", "Range Max", "double", Description = "范围判断的默认上限。", DefaultValue = 1.0)]
