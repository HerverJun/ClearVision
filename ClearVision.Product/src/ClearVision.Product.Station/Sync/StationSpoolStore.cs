...
public sealed class StationSpoolStore
{
    ...
    private static StationResultSummaryDto Clone(StationResultSummaryDto summary)
    {
        return new StationResultSummaryDto
        {
            ...
            PackageFlowHash = summary.PackageFlowHash,
            ExecutionFlowHash = summary.ExecutionFlowHash,
            FlowHash = summary.FlowHash,
            ProjectRevision = summary.ProjectRevision,
            DecisionConfigurationHash = summary.DecisionConfigurationHash,
            ExecutionSnapshotId = summary.ExecutionSnapshotId,
            ExecutionRunMode = summary.ExecutionRunMode,
            ...
            HasJudgmentSignal = summary.HasJudgmentSignal,
