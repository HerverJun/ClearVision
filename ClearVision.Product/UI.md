...
- 证据文档：`ClearVision.Product/test_results/ui_flow_min_regression_2026-03-06.md`
- 结构化结果：`ClearVision.Product/test_results/ui_flow_min_regression_2026-03-06.json`
- 2026-03-07 复核：`ClearVision.Product/test_results/ui_flow_recheck_2026-03-07.md`
- 已验证通过：登录进入工作区、工程/流程/检测/结果视图切换、新建工程、算子拖拽到画布、属性面板联动、端口连接/断连、保存、保存后重新打开、状态栏显示、登录后无新增页面错误日志。
- 2026-03-07 补充核查：清理临时排查 spec 后，`ClearVision.Product/tests/ClearVision.Product.UI.Tests` 现有 Playwright smoke `4/4` 通过，说明工作区与基础 FlowCanvas 主路径稳定。
