...
| 3 | PlanarMatching(ORB) | 7/23 (0.304348) | 60/80 (0.75) | 101.637356 | 35.477532 | 25022.378956 | 4408.856 | max=1200, ratio=0.75, ransac=5, minInlierRatio=0.25, detector=ORB, score=0.5, centerOnly=False | quality/evals/reports/PlanarMatching_hpatches_baseline.json |
| 4 | PlanarMatching(AKAZE) | 16/59 (0.271186) | 70/116 (0.603448) | 118.723182 | 8.253566 | 8648.600934 | 20655.251 | max=1600, ratio=0.75, ransac=5, minInlierRatio=0.2, detector=AKAZE, score=0.5 | quality/evals/reports/PlanarMatching_hpatches_akaze_baseline.json |
...
| PlanarMatching(ORB) | Projected quadrilateral is invalid. (10); Insufficient feature matches (4 < 6). (1); Insufficient feature matches (3 < 6). (1); isMatch=True, score=0.63, inliers=7, totalMatches=10, error=101.637, tolerance=35 (1); isMatch=True, score=0.769, inliers=148, totalMatches=149, error=44.549, tolerance=35 (1) |
