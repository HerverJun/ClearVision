...
GeneratedAtUtc: `2026-05-01T04:52:53.3073135+00:00`
Index: `quality/datasets/kolektorsdd2_index.json`
CandidateVersion: `v2`
Profile: `texture_noise_compact_circularity_area8`
...
| Compact noise area max | 96 |
| Compact noise circularity min | 0.62 |
| Compact noise fill ratio min | 0.4 |
| Min local response prominence | 3 |
| Max side | 256 |
