...
| CameraCalibration | opencv_calibration_samples | public-benchmark | Yes | 4 | ReprojectionRmsPx=0.392596, MaxReprojectionErrorPx=0.563355 | ReprojectionRmsPx <= 1.0, Failed <= 0.0 |
...
| AkazeFeatureMatch | hpatches | public-benchmark | Yes | 80 | PassRate=0.8375, P95PositionErrorPx=318.251043, MeanInliers=312.125 | PassRate >= 0.6, P95PositionErrorPx <= 500.0 |
| OrbFeatureMatch | hpatches | public-benchmark | Yes | 80 | PassRate=0.85, P95PositionErrorPx=291.625171, MeanInliers=262.8375 | PassRate >= 0.25, P95PositionErrorPx <= 700.0 |
