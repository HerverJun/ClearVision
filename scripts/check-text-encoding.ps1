param(
    [string[]]$Roots = @(
        ...
        "Acme.Product/src/Acme.Product.Desktop/wwwroot/src/features/inspection",
        "Acme.Product/src/Acme.Product.Desktop/wwwroot/src/features/results",
        "Acme.Product/src/Acme.Product.Desktop/wwwroot/src/features/stations",
        "docs/README.md",
        "docs/engineering",
        "docs/frontend",
        "docs/runtime",
