...
Write-Host "  ClearVision Studio & Station [FULL]" -ForegroundColor Cyan
Write-Host "  (Self-Contained Release Packaging)" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
$studioZipName = "ClearVision-Studio-Full-$timestamp.zip"
$stationZipName = "ClearVision-Station-Full-$timestamp.zip"
...
# 3. Compile and publish ClearVision Studio (FULL)
Write-Host "[3/5] Publishing ClearVision Studio [FULL]..." -ForegroundColor Yellow
...
Write-Host "  [OK] Studio FULL package successfully created: $studioZipPath" -ForegroundColor Green

# 4. Compile and publish ClearVision Station (FULL)
Write-Host "[4/5] Publishing ClearVision Station [FULL]..." -ForegroundColor Yellow
...
Write-Host "  [OK] Station FULL package successfully created: $stationZipPath" -ForegroundColor Green
...
Write-Host " FULL Packaging process completed successfully!" -ForegroundColor Green
