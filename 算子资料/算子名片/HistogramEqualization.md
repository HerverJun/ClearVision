...
该算子用于支持全局直方图均衡与 CLAHE，用于增强图像对比度。运行时从声明输入端口读取数据，按参数表解析配置，并把处理结果写入输出字典。
...
|--------|------|------|--------|------|------|------|
| `Method` | 方法 | `enum` | Global | Global/全局均衡化；CLAHE/CLAHE自适应 | Yes | - |
| `ClipLimit` | 裁剪限制 | `double` | 2 | [0, 100] | Yes | - |
| `TileGridSize` | 网格大小 | `int` | 8 | [1, 64] | Yes | - |
| `ApplyToEachChannel` | 逐通道处理 | `bool` | false | - | Yes | - |
...
- 组合指纹 (Generation Fingerprint)：`58C571870EA498C0AFD3E6600A38CD232B871A105FC81BBE5AE46C654D813954`
