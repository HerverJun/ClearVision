...
|------|------|------|------|------|
| `Region` | 输入区域 | `Region` | Yes | 区域开运算的主输入，必须是 Region/像素区域；Image 或 Contour 不能直接替代。 |
| `Image` | 参考图像（可选） | `Image` | No | 仅用于参考图和结果可视化，不参与区域开运算计算，也不是主输入。 |

### 输出 / Outputs
| 名称 (Name) | 显示名 (DisplayName) | 数据类型 (DataType) | 说明 (Description) |
|------|------|------|------|
| `Region` | 开运算后区域 | `Region` | 开运算得到的 Region/像素区域。 |
...
- 组合指纹 (Generation Fingerprint)：`64768EB2EC896243B77D089B743B14F09E259B25D2FA7984936A03379E1C9879`
