# 像素到物理坐标（单点） / CoordinateTransform
...
该算子用于使用 CalibrationBundleV2 的二维标定变换，将单个像素坐标转换为物理坐标。运行时从声明输入端口读取数据，按参数表解析配置，并把处理结果写入输出字典。
...
- 组合指纹 (Generation Fingerprint)：`A42A7A6B0B58C0793438F4673EF7B45959F62251804A7E9BE7D9DA86E24350BB`
