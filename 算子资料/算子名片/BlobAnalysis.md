...
- 组合指纹 (Generation Fingerprint)：`D3E7DFA521863E001286763A8D8E1F60272101DC5799F6C5A90689B46280E565`
...
|------|------|----------|
| 1.2.1 | 2026-07-15 | 按当前最终运行时元数据、条件契约和显式依赖口径重生成 / Regenerated from effective runtime metadata and declared dependencies |
