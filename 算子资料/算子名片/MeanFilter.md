...
该算子用于使用均值（方框）滤波平滑图像噪声。运行时从声明输入端口读取数据，按参数表解析配置，并把处理结果写入输出字典。
...
- 组合指纹 (Generation Fingerprint)：`80898427BC648C9A17D3A9531C8427C970F0023B241564452B048D68D40AD480`
